...
public class GeneralStoreListenersUtility extends BaseTest implements ITestListener {

	private Logger mylog = LogManager.getLogger(GeneralStoreListenersUtility.class);
	private ExtentReportUtility extentReportUtility=ExtentReportUtility.getInstance();
